...
const seedReimbursements = [
  ...
  },
  {
    ...
    description: 'Aplicativo de transporte para visita técnica',
  ...
  },
  {
    amount: 96.8,
    categoryName: 'Alimentação',
    description: 'Jantar durante viagem corporativa',
    expenseDate: new Date('2026-05-15T00:00:00.000Z'),
    rejectionReason: null,
    status: ReimbursementStatus.SUBMITTED,
  },
  {
    amount: 640,
    categoryName: 'Hospedagem',
    description: 'Hospedagem para treinamento presencial',
  ...
  },
  {
    amount: 132.45,
    categoryName: 'Combustível',
    description: 'Abastecimento para deslocamento regional',
  ...
  },
  {
    amount: 28,
    categoryName: 'Estacionamento',
    description: 'Estacionamento em aeroporto',
  ...
  },
  {
    ...
    expenseDate: new Date('2026-05-19T00:00:00.000Z'),
    rejectionReason: 'Despesa sem aprovação prévia',
    status: ReimbursementStatus.REJECTED,
  },
  {
    amount: 75,
    categoryName: 'Internet',
    description: 'Pacote adicional de dados para viagem',
