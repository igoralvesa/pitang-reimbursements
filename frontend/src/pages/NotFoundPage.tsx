    ...
    <main className="min-h-screen bg-zinc-100 px-4 py-12 dark:bg-zinc-950">
      <Card className="mx-auto max-w-lg bg-white dark:bg-zinc-900">
        <CardContent className="py-12 text-center">
          <h1 className="text-3xl font-semibold text-zinc-950 dark:text-zinc-50">Página não encontrada</h1>
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">A rota informada não existe.</p>
