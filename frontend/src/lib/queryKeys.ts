import type { GetCategoriesParams, GetReimbursementsParams, GetUsersParams } from '@/types/api';
...
export const queryKeys = {
  ...
  reimbursements: {
    ...
    lists: (params?: GetReimbursementsParams) =>
      ['reimbursements', 'list', params ?? {}] as const,
